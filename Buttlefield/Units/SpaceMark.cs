...
public class SpaceMark : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        m_color = m_material.GetColor("_ColorEnd");//m_meshRenderer.material.color;
        m_meshRenderer.enabled = false;
    }
    public void SetColor(Color color) => m_meshRenderer.enabled = true;//m_material.SetColor("_ColorEnd", color);//m_meshRenderer.material.color = color;
    public void ResetColor() => m_meshRenderer.enabled = false;//m_material.SetColor("_ColorEnd", m_color);//m_meshRenderer.material.color = m_color;
